...
Pok2 = Pokemon("Tortank", "Eau", None, 186, 148, 167, 150, 172, 143, Vibraqua, Hydro_queue, Morcure, Tour_rapide)
Pok3 = Pokemon("Florizarre", "Plante", "Poison", 187, 147, 148, 167, 167, 145, Canon_graine, Bombe_Beurk, Damoclès, Coupe_feuille)
